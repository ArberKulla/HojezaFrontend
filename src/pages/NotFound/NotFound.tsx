...
const NotFound: FunctionComponent = () => {
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 pt-10">
      ...
      {/* Text */}
      <h1 className="text-4xl sm:text-6xl font-extrabold text-yellow-500 mb-2 sm:mb-2">
        404
      </h1>
